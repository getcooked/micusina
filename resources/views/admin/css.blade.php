<meta charset="utf-8">
    ...
    <style>
        ...
        .admin-notification-trigger { align-items:center; background:#f3e8ff; border:1px solid #c084fc; border-radius:999px; color:#7c3aed; cursor:pointer; display:inline-flex; font-size:18px; height:46px; justify-content:center; width:46px; }
        .admin-notification-trigger:hover { background:#ede9fe; border-color:#7c3aed; color:#5b21b6; }
        .admin-notification-count { align-items:center; background:#ef4444; border:2px solid #fff; border-radius:999px; color:#fff; display:flex; font-size:10px; font-weight:800; height:19px; justify-content:center; position:absolute; right:-3px; top:-3px; min-width:19px; padding:0 4px; }
