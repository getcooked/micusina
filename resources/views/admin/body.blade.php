      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <button type="button" class="close text-white" data-stock-alert-close onclick="document.getElementById('lowStockAlert').classList.remove('is-visible'); document.getElementById('lowStockAlert').style.display='none'" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          </div>
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-stock-alert-close onclick="document.getElementById('lowStockAlert').classList.remove('is-visible'); document.getElementById('lowStockAlert').style.display='none'">Dismiss</button>
          </div>
        </div>
      </div>
    </div>
